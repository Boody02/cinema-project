...
<div class="col-md-6 image">
    ...
    <img style="size: 300px;" src="images/bg1.png" alt="bg">    
</div>
...
<div class="col-md-6 container2">
    ...
    <form  method="post" action="signdata.php" class="was-validated">
        ...
        <label for="Email">Email</label>
          <input type="email" style="float: right;" class="form-control"  placeholder="Enter your Email" name="email" required>
                      
        </div>
        <button type="submit" style="width: 100%; margin-top: 1%;" class="btn btn-outline-success">Submit</button>
